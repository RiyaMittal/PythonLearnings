...
sqlite_file = 'mytestDB'    # name of the sqlite database file
...
#below statement creates duplicate entry for the id_column which will throw error for creating index
